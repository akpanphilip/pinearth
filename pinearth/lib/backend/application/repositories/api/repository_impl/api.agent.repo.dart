...
class ApiAgentRepo implements IAgentRepo {
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchAgents([String searchParam = ""]) async {
    try {
      String url = "an agent/";
      ...
      if (res.status == true) {
        return Right(List.from(res.data).map((e) => AgentModel.fromJson(e)).toList());
      }
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchLandlord([String searchParam = ""]) async {
    try {
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchDeveloper([String searchParam = ""]) async {
    try {
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchHotel([String searchParam = ""]) async {
    try {
      String url = "a hotel/";
      if (searchParam.isNotEmpty) {
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchBank([String searchParam = ""]) async {
    try {
      String url = "a bank/";
      if (searchParam.isNotEmpty) {
        url = "search_hotel?search=$searchParam";
  ...
  @override
  Future<Either<IFailure, List<AgentModel>>> getOrSearchShortLet([String searchParam = ""]) async {
    try {
  ...
  @override
  Future<Either<IFailure, dynamic>> getAgentPropertyes(String agentId) async {
    try {
      final res = await apiService.get("property/an agent/$agentId", requireToken: true);
      if (res.status == true) {
