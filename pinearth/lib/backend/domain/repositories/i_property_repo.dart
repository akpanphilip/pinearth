...
abstract class IPropertyRepo {
  ...
  Future<Either<IFailure, bool>> changePropertyAvailability(String id, bool available);
  Future<Either<IFailure, dynamic>> scheduleVisit(String role, ScheduleVisitRequest request);
