...
import '../models/entities/agent_model.dart';
...
abstract class IUserRepo {
  ...
  Future<Either<IFailure, dynamic>> changePassword(
      String id, String oldPass, String newPass);
  // Get user profile
  ...
  Future<Either<IFailure, LoginResponse>> updateProfile(
      String uid, UpdateProfileRequest request);
  // Agent registration
  Future<Either<IFailure, bool>> agentRegistration(
      String type, String profileId, FormData detail);

  Future<Either<IFailure, bool>> agentProfileUpdate(
      String agentId, String type, String profileId, FormData detail);

  Future<Either<IFailure, List<UserSearchResultModel>>> searchUser(
      String param);
  Future<Either<IFailure, AgentModel>> getBusinessProfile();
  Future<Either<IFailure, AgentModel>> getBusinessAccount(String accountType);
