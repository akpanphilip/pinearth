        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'First name',
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'Last name',
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'Middle name',
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'Day / Month /  Year',
                controller: registerP.dateOfBirthController,
                readOnly: true,
                onTap: () async {
                  final date = await showDatePicker(
                    context: context, 
                    initialDate: registerP.dateOfBirth == null ? DateTime.now() : registerP.dateOfBirth!, 
                    firstDate: DateTime.now().subtract(Duration(days: 5000*365)), 
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: !ref.read(registerProvider).passwordIsVisible, hintText: 'Password',
                controller: ref.read(registerProvider).passwordController,
                suffixIcon: InkWell(
                  onTap: () => ref.read(registerProvider).togglePasswordVisibility(),
                  child: Icon(
                    ref.watch(registerProvider).passwordIsVisible ? Icons.visibility_off : Icons.remove_red_eye,
              ...
              Center(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        final canGo = ref.read(registerProvider).checkBeforeAddress();
                        if (canGo) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
