...
class _AgentDetailScreenState extends ConsumerState<AgentDetailScreen> {
  ...
  void loadAgentProperty() async {
    final res = await getIt<IAgentRepo>().getAgentPropertyes(widget.agent.id.toString());
    res.fold((l) {
      print(l.message);
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.agent.name ?? widget.agent.companyName}", style: TextStyle(
                          fontSize: 20.toFontSize(),
                          fontWeight: FontWeight.w700,
                          color: Colors.black
                        ),),
                        2.toColumnSpace(),
                        Text("${widget.agent.address}", style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            5.toRowSpace(),
                            Text('(${widget.agent.review.isEmpty ? 'No reviews' : widget.agent.review.length})', style: TextStyle(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(widget.agent.specialties.isEmpty ? "" : "Specialties: ${widget.agent.specialties}", style: TextStyle(
                    fontSize: 16.toFontSize(),
                    fontWeight: FontWeight.w400,
                    color: Colors.black
                  ),),
                  ...
                  Text("""${widget.agent.aboutYou}""", style: TextStyle(
        ...
        color: Colors.black
                      ...
                      builder: (context) {
                        if (agentProperties.isLoading()) {
                          return SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                ...List.generate(3, (index) => LoadingPropertyWidget())
                              ],
                            ),
                          );
                        }
                        ...
                        if (agentProperties.isError()) {
                          return CustomErrorWidget(message: agentProperties.message, onReload: () => loadAgentProperty());
                        }

                        final data = agentProperties.data ??[];

                        if (data.isEmpty) return EmptyStateWidget(onReload: () => loadAgentProperty(), message: "This agent does not have any property",);

                        return SingleChildScrollView(
                          scrollDirection: Axis.horizontal,
                          child: Row(
                            children: [
                              ...List.generate(data.length, (index) => PropertyWidget(
                                property: PropertyModel.fromJson(data[index]),
                              ))
                            ],
                          ),
                        );
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Ratings & reviews (${widget.agent.review.length})", style: TextStyle(
                    fontSize: 20.toFontSize(),
                    fontWeight: FontWeight.w700,
                    color: Colors.black
                  ),),
                  ...
                  Container(
                    child: Column(
                      children: [
                        Text("5/25/2023 - ryantarrant8 Helped me rent a Townhouse home in Riverside, Baltimore, MD. John did an outstanding job of helping my find an apartment. He had extensive knowledge of the area and was extremely responsive. Would 10/10 recommend him!", style: TextStyle(
                          fontSize: 13.toFontSize(),
                          color: Colors.black, 
                          fontWeight: FontWeight.w400,
                        ),),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Professional Information", style: TextStyle(
                    fontSize: 28.toFontSize(),
                    fontWeight: FontWeight.w700,
                    color: Colors.black
                  ),),
                  12.toColumnSpace(),
                  Text('Broker address:  ${widget.agent.address}',style: TextStyle(
                    fontSize: 18.toFontSize(),
                    fontWeight: FontWeight.w400,
                    color: Colors.black
                  ),),
                  24.toColumnSpace(),
                  Text('Cell phone: ${widget.agent.phoneNo}',style: TextStyle(
                    fontSize: 18.toFontSize(),
                    fontWeight: FontWeight.w400,
                    color: Colors.black
                  ),),
                  24.toColumnSpace(),
                  Text('Websites:  ${widget.agent.website}',style: TextStyle(
                    fontSize: 18.toFontSize(),
                    fontWeight: FontWeight.w400,
                    color: Colors.black
                  ),),
                  24.toColumnSpace(),
                  Text('Member since:   03/07/2023',style: TextStyle(
                    fontSize: 18.toFontSize(),
                    fontWeight: FontWeight.w400,
                    color: Colors.black
                  ),),
                  ...
                  CustomButtonWidget(
                    onClick: () {}, color: appColor.red,
                    child: Center(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(vertical: 23.0),
                        child: Text("Report this agent", style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Contact ${widget.agent.name ?? widget.agent.companyName}", style: TextStyle(
                    fontSize: 28.toFontSize(),
                    fontWeight: FontWeight.w700,
                    color: Colors.black
                  ),),
