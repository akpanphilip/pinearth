        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'E.g (bungalow etc)',
                controller: listpropertyprovider.propertyTypeController,
              ),
              20.toColumnSpace(),
              LabelTitle(text: 'Number of rooms'),
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'E.g 1 room',
                controller: listpropertyprovider.numberOfRoomsController,
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'E.g 3 bathrooms',
                controller: listpropertyprovider.numberOfBathroomController,
                inputType: TextInputType.number,
              ),
              20.toColumnSpace(),
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: 'E.g 173 Square feet',
                controller: listpropertyprovider.propertyLotSizeController,
                inputType: TextInputType.number,
              ),
              20.toColumnSpace(),
              ...
              10.toColumnSpace(),
              CustomTextField(
                obscureText: false, hintText: '2118 Thromming',
                controller: listpropertyprovider.propertyAddressController,
              ),
              if (user.role == "Agent") ...[
                20.toColumnSpace(),
                ...
                10.toColumnSpace(),
                CustomTextField(
                  obscureText: false, hintText: 'Select property owner',
                  controller: listpropertyprovider.ownerController,
                  readOnly: true,
                  suffixIcon: Icon(Icons.keyboard_arrow_right),
                  onTap: () async {
                    final owner = await showModalBottomSheet(context: context, builder: (context) {
                      return PropertyOwnerScreen();
                    }, isScrollControlled: true);
                    if (owner != null) {
                      listpropertyprovider.setOwner(owner as UserSearchResultModel);
                    }
                  },
                ),
              ],
                    ...
                    child: CustomButtonWidget(
                        onClick: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PropertySpecialSpecScreen()),
                          );
                        },
