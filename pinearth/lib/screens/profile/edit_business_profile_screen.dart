        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: GestureDetector(
                  ...
                  child: ClipRRect(
                    ...
                    child: (editBusinessProviderProvider.professionalProfilePhoto.first.startsWith("http")) ? Container(
                      height: 100, width: 100,
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: CachedNetworkImageProvider(
                            editBusinessProviderProvider.professionalProfilePhoto.first,
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: FileImage(
                            File(editBusinessProviderProvider.professionalProfilePhoto.first)
                          ),
                          fit: BoxFit.cover
                        )
                      ),
              ...
              const SizedBox(height: 10),
              CustomTextField(
                obscureText: false, hintText: '12 alakija street',
              ...
              const SizedBox(height: 10),
              CustomTextField(
                obscureText: false, hintText: 'Tell us about yourself',
              ...
              const SizedBox(height: 10),
              CustomTextField(
                obscureText: false, hintText: 'What are your specialties?',
                ...
                child: Builder(
                  builder: (context) {
                    if (editBusinessProviderProvider.companyId.isEmpty) {
                      return UploadImg(height: 50,);
                    }
                    return SelectedImagesWidget(images: editBusinessProviderProvider.companyId, height: 50,);
                  },
                )
              ),
              // CustomTextField(
              ...
              // ),
              if (![bankAgentType].contains(editBusinessProviderProvider.agentType)) ...[
                18.toColumnSpace(),
                const LabelTitle(text: 'Company Name'),
                const SizedBox(height: 10),
                CustomTextField(
                  obscureText: false, hintText: 'What is your company name',
                  controller: editBusinessProviderProvider.companyNameController,
                ),
              ],
              ...
              const SizedBox(height: 10),
              CustomTextField(
                obscureText: false, hintText: 'What is your company registration number',
