...
class _PropertyDetailScreenState extends ConsumerState<PropertyDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final propertydetailstate =
        ref.watch(propertyListProvider).propertyDetailState;
    return SafeArea(
        child: Scaffold(
      ...
      body: Builder(builder: (context) {
        ...
        final isSaved = ref
            .watch(myPropertyListingProvider)
            .isSaved(property.id.toString());
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        ...
                        Spacer(),
                        Text(
                          "${(propertyImagePageIndex + 1)}/${property.houseView.length}",
                          style: TextStyle(
                              color: Colors.white,
                    ...
                    child: PropertyDetailTabWidget(
                      ...
                      onClick: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PropertyDetailPhotoScreen(
                                    property: property)));
                      },
                      isSelected: false,
                    ),
