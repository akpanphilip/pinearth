...
class AboutAgentRegistrationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AboutAgentRegistrationScreen> createState() => _AboutAgentRegistrationScreenState();
}

class _AboutAgentRegistrationScreenState extends ConsumerState<AboutAgentRegistrationScreen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: AppbarTitle(
            text: isEdit ? 'Edit ${widget.agentType} Profile' : 'Register as ${widget.agentType}',
          ),
          centerTitle: false,
          elevation: 0.5,
        ),
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 25),
                child: Image.asset(image, height: 184,),
              ),
              60.toColumnSpace(),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 25),
                child: CustomButtonWidget(
                  onClick: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AgentRegistrationDetailScreen()));
                  },
